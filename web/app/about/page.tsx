  ...
  return (
    <main className="wrap">
      ...
      <div className="card">
        ...
        <p style={{ marginBottom: 0 }}>
          1号艇が大きく左（赤）に振れているレースは、標準どおりのイン逃げには
      ...
      {/*
        アクセス解析を入れた以上、何を集めているかは書く義務がある。
        「集めない」ほうを具体的に書くのは、書いていないものが
        集められているのではないかという疑いに答えるため。
        導入している道具を変えたら、この記載も必ず直すこと。
      */}
      <div className="card">
        <h2>アクセス解析</h2>
        <p style={{ marginTop: 0 }}>
          どのページがどれだけ見られているかを知るために、Vercel Web Analytics で
          ページの表示回数を数えています。集めているのは次の項目です。
        </p>
        {/* globals.css にリストの定義が無いので、字下げだけ本文に寄せる */}
        <ul style={{ marginTop: 0, paddingLeft: 20 }}>
          <li>表示したページのURLと、そこへ来る前のページ（リファラ）</li>
          <li>表示した日時</li>
          <li>国・地域までの大まかな所在地</li>
          <li>ブラウザ・OS・端末の種別（PC／スマートフォンなど）</li>
        </ul>
        <p>
          <strong>cookie は使っていません。</strong>
          ブラウザに保存する識別子も持ちません。訪問者はリクエストから作られる
          ハッシュで数えられ、これは24時間で破棄されるため、日をまたいで
          同じ人を追いかけることはできません。他サイトでの行動と突き合わせる
          仕組みもありません。
        </p>
        <p style={{ marginBottom: 0 }}>
          このサイトにはログインも入力フォームも無いので、氏名・メールアドレス・
          購入履歴といった個人を特定できる情報は、そもそも受け取っていません。
          広告も配信していません。
        </p>
      </div>
    </main>
