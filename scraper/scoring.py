...
# 日付で学習と検証に分け、検証660レースを採点している。
#
#   w     三連単LogLoss  市場との差         1着LogLoss  m/k=4 の買い目のEV
#   0.0     3.7477       —                  1.1513      0.75
#   0.1     3.7483       +0.0006 ± 0.0032   1.1535      0.97
#   0.2     3.7549       +0.0072 ± 0.0060   1.1567      1.20   ← 採用
#   0.3     3.7668       +0.0191 ± 0.0088   1.1608      1.42
#   0.5     3.8067       +0.0589 ± 0.0143   1.1721      1.87
#   1.0     4.1310       +0.3833 ± 0.0428   1.2222      3.00   ← 9/7まではここ
#
